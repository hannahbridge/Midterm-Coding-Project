...
public abstract class Person implements java.io.Serializable 
{
			...
			Date DOB, String Address, String Phone_number, String Email) throws PersonException
	{
		...
		Date compareToThisDate = new Date(todaysDate.getYear(), todaysDate.getMonth(), todaysDate.getDay());
		compareToThisDate.setYear(compareToThisDate.getYear() + 1800);
		
		if(this.getDOB().before(compareToThisDate))
		{
			throw new PersonException(this);
		}
